...
: ${AMENT_CURRENT_PREFIX:="/workspaces/polymath_workspace/src/hemisphere_gnss_v500_driver/install/hemisphere_gnss_v500_driver"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hemisphere_gnss_v500_driver/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hemisphere_gnss_v500_driver/environment/path.sh"
