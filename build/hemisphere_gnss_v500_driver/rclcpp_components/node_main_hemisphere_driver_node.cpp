...
#define NODE_MAIN_LOGGER_NAME "hemisphere_driver_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libhemisphere_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<hemisphere_gnss_v500_driver::HemisphereDriverNode>";
